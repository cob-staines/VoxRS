...
def las_ray_sample_by_z_slice(vox, z_slices=1, fail_overflow=False):
    ...
    :param fail_overflow: boolean: do you want to run checks to make sure voxel counts do not overflow? Heads up, this is VERY computationally expensive.
    :return: voxel object
    """
...
def las_to_vox(vox, z_slices, run_las_traj=True, fail_overflow=False, posterior_calc=True):
    ...
    if run_las_traj:
        ...
        ltm.las_traj(vox.las_in, vox.traj_in, vox.las_traj_hdf5, vox.las_traj_chunksize, vox.return_set, vox.drop_class)
