...
#preview hemispheres
def hemi_view(batch_dir, ii, cn_coef=0.38):
    # batch dir is directory to hemispherical batch folder
    # ii is index of hemisphere wanting to preview
    # cn_coef is contact number scaling coefficient. See supplementary material for Staines & Pomeroy 2023
    ...
    returns = tif.imread(batch_dir + "outputs\\" + rshmeta.file_name[ii])
    contacts = im * cn_coef
